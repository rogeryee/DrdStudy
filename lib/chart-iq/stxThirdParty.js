(function(){
	...
	
	{
		...
		if ( typeof define === "function" && define.amd ) {
			define( function(_stxTZData) { return _stxThirdParty_js(_stx3rdParty_js_exports); } );
		}else{
			window.STXThirdParty=_stxThirdParty_js(_stx3rdParty_js_exports);
			if(typeof STX_namespaced=="undefined") {for(var func in window.STXThirdParty) eval("window."+func+"=window.STXThirdParty."+func);}  //copy STXThirdParty into window
		}
	}
